...
**Последнее изменение:** 26.01.2026, 16:44 МСК
...
4.2.3. При необходимости 3D-карта может быть актуализирована. Оборудование и его геопривязка при этом не меняются.
...
5.1. Формирование базы цифровой тени: создание 3D-карты территории автоматизации.
...
5.5. Настройка отчетности: создание инфошаблонов и панелей мониторинга.
