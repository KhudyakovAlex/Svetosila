...
**Видео-токен в дневнике и статусе:**
- Если в тексте встречается `{видео}`, он заменяется на ссылку на файл `PROJECT/INDEX/assets/video/SVETOSILA.mp4`
- На странице отображается текст ссылки: `Видео`
