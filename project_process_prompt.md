...
**Относительные ссылки (локально + GitHub Pages):**
- Также конвертируются ссылки вида `assets/...` (например: `assets/video/SVETOSILA.mp4`)
- Пиши видео в дневнике/статусе именно так: `assets/video/SVETOSILA.mp4` — откроется и локально, и на сайте
